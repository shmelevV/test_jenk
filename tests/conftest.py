...
from configs import common_parsing
...
def groups_page(browser):
    login_page = LoginPage(browser)
    login_page.login(common_parsing.username, common_parsing.password)
...
def log_in_new_user(browser):
    ...
    login_page = LoginPage(browser)
    login_page.open_login_page()
    login_page.login(common_parsing.new_username, common_parsing.new_password)
